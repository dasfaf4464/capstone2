...
CREATE TABLE IF NOT EXISTS images (
    ...
    is_selected BOOLEAN NOT NULL DEFAULT FALSE, -- 5장의 사진을 위한 임시 사진 테이블이 필요한지 아니면 다 사진에 저장하고 한장만 선택해서 true로
    user_uuid UUID REFERENCES users(user_uuid) ON DELETE CASCADE -- 외래키 쓸 때 타입 같아야 한다고 합니다
);
